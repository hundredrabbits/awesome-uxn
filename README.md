...
- [Monotal](https://git.sr.ht/~ismael-vc/monotal) - Uxntal lexers and Monokai light/dark themes for the Micro CLI editor, Sublime Text 3, Pygments, SourceHut and Uxnomicon (MediaWiki).
